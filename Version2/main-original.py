...
async def statuses():
    ...
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('another rewrite is in the works...'))
    await asyncio.sleep(60)
    await client.change_presence(activity=discord.Game('not v3.0 | .help'))
    await asyncio.sleep(60)
...
# Commands without prefix
    ...
    elif content == 'the battery is full':
